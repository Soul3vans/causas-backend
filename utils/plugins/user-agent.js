...
const generateRandomUA = () => {
  // Array de User-Agents actualizados (2024-2026)
  const userAgents = [
    // === CHROME (Windows, Mac, Linux) - 15+ agentes ===
    ...
    // === FIREFOX (Windows, Mac, Linux) - 15+ agentes ===
    ...
    // === MICROSOFT EDGE (Chromium) - 15+ agentes ===
