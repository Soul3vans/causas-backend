...
module.exports = {
  noUpdated: ({ name, totalCases }) => {
                  ...
                  <div class="templates">
                    <div class="templates-content">
                      ...
                      <div class="templates-body">
                          ...
                          <div>
                            <p>Le comunicamos que; de un total de ${
                              totalCases === 1
                                ? totalCases + ' causa revisada'
                                : totalCases + ' causas revisadas'
                            } no fueron encontradas actualizaciones posibles</p><br />
                          </div>
                     </div>
                     </div>
    ...
    //               <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800" rel="stylesheet">
    //               <link href="https://fonts.googleapis.com/css?family=Poppins:400,700,900" rel="stylesheet">
    //               <title>E-legal Cases Info</title>
    //               <style media="screen">
    //                 *{
    //                   box-sizing: border-box;
    //                   margin: 0;
    ...
    //                       </div>
    //                       <div>
    //                         <p>Le comunicamos que, de un total de ${totalCases} causa(s) revisada(s) no se encontraron actualizaciones posibles</p><br />
    //                       </div>
    //                  </div>
    //                 </div>
    //               </div>
...
// const noUpdated = async paramsOptions => {
//   console.log('paramsOptions.email')
//   console.log(paramsOptions.email)
// }
